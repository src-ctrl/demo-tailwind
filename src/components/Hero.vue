            ...
            <div class="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
              <div class="flex items-center justify-between w-full md:w-auto">
                ...
                <div class="-mr-2 flex items-center md:hidden">
                  <button id="main-menu" @click="isOpen = !isOpen" type="button" class="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500" aria-haspopup="true">
...
<script>
  /*
  We've included a basic click handler here to demonstrate the general idea,
  but please reference the WAI-ARIA Authoring Practices when building components
  like this to ensure you implement all of the necessary keyboard interactions
  and properly manage any required ARIA attributes.
  https://tailwindui.com/documentation#js-vue
  */
  export default {
    name: "Hero",
    data: () => ({
